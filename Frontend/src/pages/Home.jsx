...
export default function Home() {
  ...
  const services = [
    {
      ...
      items: ["Monthly GST Filings", "Annual Income Tax Returns", "Tax Planning & Optimization", "Compliance & Verification"],
    ...
    },
    {
      ...
      items: ["Company Registration", "LLP & Proprietorship Setup", "Shop Act Licenses", "PAN & ITR Registrations"],
    ...
    },
    {
      ...
      items: ["Trademark & Patent Filing", "Professional Accounting", "Compliance Management", "Regulatory Guidance"],
    ...
    },
    {
      ...
      items: ["Business Advisory", "Financial Planning", "Investment Advice", "Wealth Tax Support"],
  ...
  const whyChooseUs = [
    { icon: "👥", title: "Expert Team", desc: "Experienced professional dedicated to your success", bgColor: "bg-blue-50", accentColor: "text-blue-600" },
    { icon: "✅", title: "Compliance Assured", desc: "100% compliance assured across all services", bgColor: "bg-green-50", accentColor: "text-green-600" },
    { icon: "🎯", title: "Personalized Service", desc: "Customized solutions tailored to your needs", bgColor: "bg-purple-50", accentColor: "text-purple-600" }
  ];
  ...
  const serviceCards = [
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1553729717-e91a2f023c1d?w=500&h=400&fit=crop"
    }
  ];
  ...
  useEffect(() => {
    axios.get("http://localhost:5000/api/images/type/owner")
      .then(res => {
    ...
    axios.get("http://localhost:5000/api/images/admin/all")
      .then(res => {
        const logos = res.data.filter(img => img.image_type === "clients_logo");
        setClientsLogos(logos);
      })
      .catch(err => console.log("Could not load clients logos:", err.message));
  }, []);
...
<div className="py-20 px-6 md:px-10 bg-white">
  ...
  <p className="text-gray-700 text-lg leading-relaxed max-w-xl">
    We are prominent tax and financial consultants in Pune. With over two decades of expertise, we offer comprehensive services including GST filing, income tax returns, business registrations, professional accounting, compliance management, and financial consulting for individuals and businesses across India.
  </p>

  <p className="text-gray-600 leading-relaxed max-w-xl">
    Our commitment is to deliver precision, compliance, and growth for every client. We handle your financial compliance with expertise while you focus on your business growth.
  </p>

  <button className="mt-4 bg-gradient-to-r from-blue-600 to-cyan-500 hover:from-blue-700 hover:to-cyan-600 text-white font-semibold px-8 py-4 rounded-xl shadow-lg transition transform hover:scale-105">
    Explore More About Us
      ...
      <div className="py-20 px-6 md:px-12 bg-gray-100">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-5xl font-bold text-gray-900 mb-4">Solutions Tailored to Your Needs, Service Perfected</h2>
          ...
          <div className="relative">
            <div className="grid md:grid-cols-3 gap-8">
              {getVisibleCards().map((card) => (
                <div key={card.id} className="group relative overflow-hidden rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 h-80">
                  <img 
                    src={card.image} 
                    alt={card.title}
      ...
      <div className="py-20 px-6 md:px-12 bg-gradient-to-b from-white to-gray-50">
        <div className="max-w-6xl mx-auto">
          <div className="mb-16 text-center">
            ...
            <h2 className="text-5xl font-bold text-gray-900 mb-4">Comprehensive Services</h2>
            <p className="text-gray-600 text-lg max-w-3xl mx-auto">
              From GST and income tax filing to business registrations and specialized services, we provide end-to-end financial solutions.
            </p>
          </div>

          <div className="grid md:grid-cols-2 gap-8">
            {services.map((service, idx) => (
              <div key={idx} className={`bg-gradient-to-br ${service.color} border-2 ${service.borderColor} p-8 rounded-2xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105`}>
                <div className="text-5xl mb-6">{service.icon}</div>
                <div className={`w-16 h-1 ${service.accentColor} mb-4 rounded`}></div>
                <h3 className="text-2xl font-bold text-gray-900 mb-6">{service.title}</h3>
                <ul className="space-y-3">
                  {service.items.map((item, i) => (
                    <li key={i} className="text-gray-700 flex items-start">
                      <span className={`${service.accentColor} text-white rounded-full w-5 h-5 flex items-center justify-center mr-3 mt-0.5 flex-shrink-0 text-sm`}>✓</span>
      ...
      <div className="py-20 px-6 md:px-12 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <div className="w-16 h-1 bg-gradient-to-r from-teal-500 to-cyan-500 mb-6 mx-auto"></div>
            <h2 className="text-5xl font-bold text-gray-900 mb-4">Why Choose B N Narwade & Co.?</h2>
            <p className="text-gray-600 text-lg max-w-3xl mx-auto">
              With years of expertise in tax consulting and financial services, we deliver exceptional solutions.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-start">
            ...
            <div className="space-y-6">
              {whyChooseUs.map((item, idx) => (
                <div key={idx} className={`${item.bgColor} border-l-4 border-gray-300 p-6 rounded-lg hover:shadow-lg transition`}>
                  <div className="flex gap-4">
                    <div className="text-4xl">{item.icon}</div>
                    <div>
                      <h3 className={`font-bold text-gray-900 text-lg ${item.accentColor}`}>{item.title}</h3>
            ...
            <div className="bg-gradient-to-br from-teal-500 to-cyan-500 rounded-2xl p-10 text-white shadow-2xl">
              ...
              <div className="space-y-6 mb-8">
                <div className="flex items-start gap-4 bg-white/10 p-5 rounded-xl backdrop-blur">
                  ...
                  <div>
                    <h4 className="font-bold text-lg">100% Accuracy Guaranteed</h4>
                    <p className="text-teal-50 text-sm mt-1">Precise calculations every time</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 bg-white/10 p-5 rounded-xl backdrop-blur">
                  ...
                  <div>
                    ...
                    <p className="text-teal-50 text-sm mt-1">Always here when you need us</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 bg-white/10 p-5 rounded-xl backdrop-blur">
                  ...
                  <div>
                    ...
                    <p className="text-teal-50 text-sm mt-1">Professional guidance throughout</p>
                  </div>
                </div>
              </div>
      ...
      <div className="py-20 px-6 md:px-12 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <div className="w-16 h-1 bg-gradient-to-r from-teal-500 to-cyan-500 mb-6 mx-auto"></div>
            <h2 className="text-5xl font-bold text-gray-900 mb-4">Our Trusted Clients</h2>
            <p className="text-gray-600 text-lg max-w-3xl mx-auto">
          ...
          {clientsLogos.length > 0 ? (
            ...
            <div className="text-center py-12 bg-gray-50 rounded-xl">
              <p className="text-gray-500 text-lg">Client logos coming soon...</p>
            </div>
          )}
        </div>
      </div>
      ...
      <div className="py-20 px-6 md:px-12 bg-gradient-to-r from-gray-50 to-gray-100">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-gray-600 text-lg mb-10">
            Ready to simplify your financial compliance? Get in touch for a free consultation.
          </p>
